...
Each surface below is a visual source of truth. Implement this design from Figma. The screenshot is shown inline for direct review in Markdown.

## Workspace dropdown

Figma: https://www.figma.com/design/KUVm6tSK6eyT89tZGuSko1/Dashboard-Workflow-UI?node-id=110-2&m=dev

![Workspace dropdown](<workspace dropdown.png>)
...
![Import workspace modal](<import workspace modal.png>)
...
![Feature tab - product spec default](<feature tab -  product spec (default).png>)
...
![Feature tab - technical design](<feature tab - technical design.png>)

## Feature tab - tasks

Figma: https://www.figma.com/design/KUVm6tSK6eyT89tZGuSko1/Dashboard-Workflow-UI?node-id=110-1660&m=dev

![Feature tab - tasks](<feature tab - tasks.png>)
