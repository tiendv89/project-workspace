# J22 - Read feature tab content

1. The user opens a feature tab.
2. The app shows the feature identity and current feature state from backend detail data.
3. The user can move between feature views: Product Spec, Technical Design, Tasks, and Logs.
4. Source documents are readable inside the dashboard.
5. Feature activity and task summaries are visible when available.
